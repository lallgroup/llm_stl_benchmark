...
on some tasks.  NL-critique in fact \emph{regresses} the iter-0 baseline ($11.4\,\% \to 10.6\,\%$):
two plans that passed all seven properties before the critique fail at least one
afterwards, and P1 / P6 pass rates drop by four points each.  FV-guided lifts convergence to 46.4\,\% ($\Delta{=}+35$
...
nl-critique   & 273 & 10.6 & 2.79 & 100 & 37 & 100 & 90 & 28 & 99 & 37 \\
