...
pass) at $k{=}2$.  Under the FV-guided condition, GPT-5.1 reaches convergence
on 75.5\,\% of tasks in a mean of 2.44 iterations.  The NL-critique baseline
\emph{underperforms} vanilla (0.7\,\% vs.\ 1.5\,\%), despite using the full
three-iteration budget on 99\,\% of tasks: without a concrete target, the
model's self-edits are as likely to introduce regressions as fix defects.

\begin{table}[h]
\centering
\caption{Convergence of GPT-5.1 plans under three conditions ($n{=}273$,
$K{=}3$ iterations). Final-iteration pass rates in \%.}
\label{tab:replan-conditions}
\small
\begin{tabular}{lrrrrrrrrr}
\toprule
Condition & Conv. (\%) & iters & P0 & P1 & P2 & P3 & P4 & P5 & P6 \\
\midrule
vanilla       &  1.5 & 1.00 & 100 & \phantom{0}8  & 100 & 80 & 29 & 100 & \phantom{0}9 \\
nl-critique   &  0.7 & 2.99 &  99 & \phantom{0}8  & 100 & 71 & 26 & 100 & \phantom{0}8 \\
fv-guided     & \textbf{75.5} & 2.44 & 100 & \textbf{100} & 99  & \textbf{91} & \textbf{85} & 98  & \textbf{100} \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.55\linewidth]{figures/figure1_convergence.pdf}
\caption{All-properties-pass rate as a function of re-planning iteration.
Formal-verification feedback lifts GPT-5.1 from 1.5\,\% single-shot to
75.5\,\% by iteration 2.  Unstructured self-critique plateaus at 0.7\,\%.}
...
the plan, and without domain-specific prompt engineering on the
baseline.\footnote{Full code and traces are available at
